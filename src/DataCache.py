...
class DataCache:
    ...
    def src2DestRemap(self, autoFieldName, objType, autoValue):
        ...
        if autoValue in self.cacheStruct[autoFieldName][objType][constants.DATA_SOURCE.DEST]:
            srcUserValue = self.cacheStruct[autoFieldName][objType][constants.DATA_SOURCE.DEST][autoValue]
